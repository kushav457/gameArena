...
import { CssBaseline, ThemeProvider, AppBar, Toolbar, Typography, IconButton, Box, Link } from "@mui/material";
...
export default function Layout({ children, filters, onFilterChange }) {
  ...
  // Admin dashboard should not get the landing navbar/footer.
  const hideChrome = router.pathname.startsWith("/admin");

  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      {!hideChrome && <NavBar filters={filters} onFilterChange={onFilterChange} />}
